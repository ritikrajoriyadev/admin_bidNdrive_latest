    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="indigo-500/60">Loading profile...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="indigo-500/50 mt-1">Manage your account information</p>
          </div>
          <button
        ...
        <div className="bg-white border border-white/10 rounded-3xl overflow-hidden">
          ...
          <div className="px-8 -mt-12 pb-8">
            <div className="flex flex-col items-center">
              ...
              <p className="indigo-500/50 flex items-center gap-2 mt-1">
          ...
          {/* Footer Actions */}
          <div className="border-t border-white/10 p-6 flex gap-3 indigo-500/30">
...
const DetailItem = ({ icon, label, value, highlight = false }) => (
  <div className="group">
    <div className="flex items-center gap-3">
      <div className="w-9 h-9 rounded-xl bg-white/5 flex items-center justify-center indigo-500/70 group-hover:indigo-500 transition-colors">
        {icon}
      </div>
      <div className="flex-1 min-w-0">
        <p className="text-xs indigo-500/40 font-medium tracking-widest uppercase">{label}</p>
        <p className={`font-medium ${highlight ? "text-indigo-400" : "indigo-500"} truncate`}>
          {value}
        </p>
      </div>
    </div>
