...
const TextInput = ({ value, onChange, placeholder = '' }) => (
  <input
    ...
    className="w-full px-3 py-2 rounded-lg bg-white/[0.03] border border-white/[0.07] text-white/70 text-xs placeholder-white/20 focus:outline-none focus:border-teal-500/40 focus:bg-white/[0.05] transition-all"
  />
);
...
const SelectInput = ({ value, onChange, options }) => (
  <select
    value={value}
    onChange={e => onChange(e.target.value)}
    className="w-full px-3 py-2 rounded-lg bg-white/[0.03] border border-white/[0.07] text-white/70 text-xs focus:outline-none focus:border-teal-500/40 transition-all appearance-none"
  >
      ...
      <Section title="Vehicle Identity" defaultOpen>
        ...
        <Field label="Odometer (km)">
          <input type="number" value={odometer} onChange={e => setOdometer(e.target.value)}
            className="w-full px-3 py-2 rounded-lg bg-white/[0.03] border border-white/[0.07] text-white/70 text-xs focus:outline-none focus:border-teal-500/40 transition-all" />
        </Field>
