    ...
    {options.map(c => {
      ...
      return (
        <button key={c} type="button"
          ...
          className={`px-2 py-0.5 rounded text-[10px] font-semibold transition-all capitalize border ${active ? 'bg-amber-500/20 border-amber-500/40 text-amber-400' : 'bg-transparent indigo-500 indigo-500/25 hover:indigo-500/40'
            }`}>
          {c.replace(/_/g, ' ')}
        </button>
      );
...
const Toggle = ({ label, value, onChange, extra = '' }) => (
  <div className="flex items-center justify-between py-2">
    <span className="indigo-500/40 text-xs">{label}{extra && <span className="indigo-500/20 ml-1 text-[10px]">{extra}</span>}</span>
...
const NumberInput = ({ label, value, onChange }) => (
  <div className="flex items-center justify-between py-2 border-b border-white/[0.04] last:border-0">
    ...
    <input type="number" value={value} onChange={e => onChange(e.target.value)} min={0} max={20}
      className="w-16 px-2 py-1 rounded-lg bg-white/[0.03] border indigo-500 indigo-500/70 text-xs text-right focus:outline-none focus:border-teal-500/40 transition-all" />
  </div>
);
    ...
    <div className="space-y-2">
      ...
      <Section title="Interior Cabin" defaultOpen>
        <div className="flex items-center justify-between mb-2">
          <span className="indigo-500/50 text-xs font-medium">Cabin Status</span>
      ...
      <Section title="Door Trim">
        <div className="flex items-center justify-between mb-2">
          <span className="indigo-500/50 text-xs font-medium">Door Trim Status</span>
      ...
      <Section title="Seats">
        <div className="py-2 border-b border-white/[0.04]">
          <div className="flex items-center justify-between mb-1">
            <span className="indigo-500/40 text-xs">Leather Seat</span>
      ...
      <Section title="Roof Lining">
        <div className="flex items-center justify-between mb-2">
          <span className="indigo-500/50 text-xs font-medium">Roof Lining Status</span>
      ...
      <Section title="Safety & Electricals">
        <div className="py-2 border-b border-white/[0.04]">
          <div className="flex items-center justify-between mb-1">
            <span className="indigo-500/40 text-xs">ABS</span>
        ...
        <div className="pt-2 border-t border-white/[0.04] mt-1">
          <div className="flex items-center justify-between">
            <span className="indigo-500/40 text-xs">Overall Electrical</span>
      ...
      <Section title="Music System">
        <div className="flex items-center justify-between mb-2">
          <span className="indigo-500/50 text-xs font-medium">Music System Status</span>
