    ...
    <div className="rounded-2xl bg-white border border-white/[0.06] p-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex flex-col gap-3">
          ...
          {roles.length === 0 ? (
            <p className="indigo-500/30 text-sm">Loading roles…</p>
          ) : (
              ...
              {roles.map((role) => {
                ...
                return (
                  ...
                  >
                    ...
                    {role.description && (
                      <p className="indigo-500/40 text-xs mt-0.5 truncate">{role.description}</p>
                    )}
                    <p className="indigo-500/30 text-xs mt-1">
...
export default function SubAdmin() {
  ...
  return (
    <div className="flex flex-col gap-6">
      {/* Header */}
      <div className="flex flex-col gap-2">
        <h1 className="text-3xl font-bold indigo-500">SubAdmin Management</h1>
        <p className="indigo-500/40 text-sm">Create and manage subadmin accounts with roles and permissions</p>
      </div>
      ...
      <div className="rounded-2xl bg-white border border-white/[0.06] overflow-hidden">
        {loading ? (
          <div className="p-8 flex items-center justify-center indigo-500/40">Loading subadmins…</div>
        ) : filteredAdmins.length === 0 ? (
          <div className="p-8 flex items-center justify-center indigo-500/40">No subadmins found</div>
        ) : (
