import { n as __esmMin, o as __toESM } from "./chunk-olfrzTEO.js";
import { n as require_promises, s as require_browser_external_node_path, t as require_browser_external_node_url } from "./eslint_use-at-your-own-risk.js";
...
//#endregion
//#region node_modules/@humanfs/core/src/errors.js
var init_errors = __esmMin((() => {}));
//#endregion
//#region node_modules/@humanfs/core/src/index.js
...
//#endregion
//#region node_modules/@humanfs/node/src/node-hfs.js
var import_browser_external_node_path, import_promises, import_browser_external_node_url, RETRY_ERROR_CODES, NodeHfsDirectoryEntry, NodeHfsImpl, NodeHfs, hfs;
var init_node_hfs = __esmMin((() => {
	init_src$1();
	import_browser_external_node_path = /* @__PURE__ */ __toESM(require_browser_external_node_path(), 1);
	init_retrier();
	import_promises = /* @__PURE__ */ __toESM(require_promises(), 1);
	import_browser_external_node_url = require_browser_external_node_url();
	...
	NodeHfsImpl = class {
		...
		async write(filePath, contents) {
			...
			return this.#retrier.retry(() => this.#fsp.writeFile(filePath, value)).catch((error) => {
				if (error.code === "ENOENT") {
					const dirPath = import_browser_external_node_path.default.dirname(filePath instanceof URL ? (0, import_browser_external_node_url.fileURLToPath)(filePath) : filePath);
		...
		*/
		async copyAll(source, destination) {
			...
			const sourceStr = source instanceof URL ? (0, import_browser_external_node_url.fileURLToPath)(source) : source;
			const destinationStr = destination instanceof URL ? (0, import_browser_external_node_url.fileURLToPath)(destination) : destination;
			await this.createDirectory(destination);
			for await (const entry of this.list(source)) {
				const fromEntryPath = import_browser_external_node_path.default.join(sourceStr, entry.name);
				const toEntryPath = import_browser_external_node_path.default.join(destinationStr, entry.name);
...
//# sourceMappingURL=src-CkKSHiZo.js.map