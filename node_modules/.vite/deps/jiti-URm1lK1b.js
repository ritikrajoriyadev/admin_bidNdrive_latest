import { n as __esmMin, o as __toESM, t as __commonJSMin } from "./chunk-olfrzTEO.js";
import { a as require_browser_external_node_assert, c as require_browser_external_node_fs, i as require_browser_external_node_util, o as require_browser_external_node_module, r as require_browser_external_node_os, s as require_browser_external_node_path, t as require_browser_external_node_url } from "./eslint_use-at-your-own-risk.js";
//#region browser-external:node:process
var require_browser_external_node_process = /* @__PURE__ */ __commonJSMin(((exports, module) => {
...
//#endregion
//#region browser-external:node:v8
var require_browser_external_node_v8 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = Object.create(new Proxy({}, { get(_, key) {
		if (key !== "__esModule" && key !== "__proto__" && key !== "constructor" && key !== "splice") console.warn(`Module "node:v8" has been externalized for browser compatibility. Cannot access "node:v8.${key}" in client code. See https://vite.dev/guide/troubleshooting.html#module-externalized-for-browser-compatibility for more details.`);
	} }));
}));
//#endregion
...
var require_browser_external_node_tty = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = Object.create(new Proxy({}, { get(_, key) {
...
//#endregion
//#region browser-external:node:perf_hooks
var require_browser_external_node_perf_hooks = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = Object.create(new Proxy({}, { get(_, key) {
		if (key !== "__esModule" && key !== "__proto__" && key !== "constructor" && key !== "splice") console.warn(`Module "node:perf_hooks" has been externalized for browser compatibility. Cannot access "node:perf_hooks.${key}" in client code. See https://vite.dev/guide/troubleshooting.html#module-externalized-for-browser-compatibility for more details.`);
	} }));
}));
//#endregion
...
var require_jiti = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(() => {
		...
		(() => {
			...
			const e = require_browser_external_node_os();
			var t = [
				509,
				0,
				227,
			...
			const le = require_browser_external_node_module(), ue = require_browser_external_node_fs();
			String.fromCharCode;
			const de = /\/$|\/\?|\/#/, fe = /^\.?\//;
			...
			}, _e = require_browser_external_node_url(), Ee = require_browser_external_node_assert(), be = require_browser_external_node_process(), Se = require_browser_external_node_path(), ke = require_browser_external_node_v8(), we = require_browser_external_node_util(), Ie = new Set(le.builtinModules);
			...
			var ut = { rE: "2.6.1" };
			const dt = require_browser_external_node_crypto();
			...
			}), xt = typeof process < "u" && process.env && "development" || "", vt = [
				["APPVEYOR"],
				[
					"AWS_AMPLIFY",
					"AWS_APP_ID",
			...
			const Ot = require_browser_external_node_tty()?.WriteStream?.prototype?.hasColors?.() ?? !1, base_format = (e, t) => {
				if (!Ot) return (e) => e;
				const i = `[${e}m`, s = `[${t}m`;
				return (e) => {
					const r = e + "";
			...
			const Gt = require_browser_external_node_perf_hooks(), Ht = require_browser_external_node_vm();
...
function lazyTransform(...args) {
	if (!_transform) _transform = (0, import_browser_external_node_module.createRequire)(import.meta.url)("../dist/babel.cjs");
...
function createJiti(id, opts = {}) {
	...
	return (0, import_jiti.default)(id, opts, {
		onError,
		nativeImport,
		createRequire: import_browser_external_node_module.createRequire
	});
}
var import_browser_external_node_module, import_jiti, nativeImport, _transform;
//#endregion
__esmMin((() => {
	import_browser_external_node_module = require_browser_external_node_module();
	import_jiti = /* @__PURE__ */ __toESM(require_jiti(), 1);
	nativeImport = (id) => import(id);
}))();
export { createJiti, createJiti as default };

//# sourceMappingURL=jiti-URm1lK1b.js.map